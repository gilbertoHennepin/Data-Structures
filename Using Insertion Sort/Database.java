...
/*******************************************************************/
    ...
    public void insertionSort() {
        ...
        /* TODO 3: Create a for-loop that starts with unsorted_Indx = 1
        ...
        for (int unsortedIndx = 1; unsortedIndx < regCount; unsortedIndx++) {
            ...
            while (sortedIndx >= 0) {
                ...
                // TODO 9: Comment out the print statement and the sortedIndex-- statements.
                ...
                if (sortedReg.license.compareTo(unsortedReg.license) > 0) {
                    ...
                    /* TODO 12: If the sortedReg license is less than or equal
                        to the unsortedReg license, then break out of the while loop  */
                    break;
                }
            }

            /* TODO 13: After the while-loop but before returning to the
                top of the for-loop, set the element at sortedIndx + 1 to
                the unsortedReg */
